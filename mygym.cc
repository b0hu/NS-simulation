...
namespace ns3{
    ...
    Ptr<OpenGymInterface> openGym = CreateObject<OpenGymInterface> (2222);
    ...
    */
    ...
    GetReward(void)
    {
        float reward = 100 * (pow((embbthruput * 30), 2) - pow((urllcdelay * 15), 2) + pow((mmtcthruput * 50), 2) - pow((mmtcdelay * 50), 2));
